...
- **Task 工具**：新增 `TaskCreate`、`TaskGet`、`TaskList`、`TaskUpdate`（详见 [Plan](/zh/versions/2.0.5/building-blocks/plan) 页面）。([#1549](https://github.com/agentscope-ai/agentscope/pull/1549))
