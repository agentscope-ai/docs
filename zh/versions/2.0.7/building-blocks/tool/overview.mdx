...
<CardGroup cols={2}>
  <Card title="Python 函数工具" icon="code" href="/zh/versions/2.0.7/building-blocks/tool/python-tool">
    内置工具、自定义工具、函数包装与工具中间件。
  </Card>
  <Card title="MCP" icon="plug" href="/zh/versions/2.0.7/building-blocks/tool/mcp">
    接入 MCP 服务并使用其工具。
  </Card>
  <Card title="Skill" icon="book-open" href="/zh/versions/2.0.7/building-blocks/tool/skill">
    用 Markdown 指令集拓展智能体能力。
  </Card>
  <Card title="元工具" icon="toggle-on" href="/zh/versions/2.0.7/building-blocks/tool/manage-tools">
    让智能体在运行时自主激活或停用工具组。
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="智能体" icon="robot" href="/zh/versions/2.0.7/building-blocks/agent/overview">
    智能体如何在 ReAct 循环中编排工具调用。
  </Card>
  <Card title="权限系统" icon="shield" href="/zh/versions/2.0.7/building-blocks/permission-system/overview">
    精细控制哪个工具可以执行、何时执行。
  </Card>
</CardGroup>
