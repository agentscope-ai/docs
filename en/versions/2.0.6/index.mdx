...
<CardGroup cols={1}>
	<Card title="ReAct Agent" icon="robot" href="/en/versions/2.0.6/building-blocks/agent/overview" cta="Get Started">
	...
	<Card title="Toolkit" icon="toolbox" href="/en/versions/2.0.6/building-blocks/tool/overview" cta="Learn about toolkit">
		Agent self-managed tool system with Python functions, MCP and skills integration.
	</Card>
	<Card title="Context" icon="memory" href="/en/versions/2.0.6/building-blocks/context/overview" cta="View context">
	...
	<Card title="Sandbox Isolation" icon="codepen" href="/en/versions/2.0.6/building-blocks/workspace/overview" cta="Learn about sandbox">
	...
	<Card title="Agent as Service" icon="server" href="/en/versions/2.0.6/deploy/agent-service" cta="Learn about agent service">
