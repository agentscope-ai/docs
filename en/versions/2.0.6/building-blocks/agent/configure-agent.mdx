...
| `injection_config` | `InjectionConfig` | default | Runtime state injection: time, tasks, and context usage (see [Environment Awareness](/en/versions/2.0.6/building-blocks/context/environment-awareness)) |
...
<CardGroup cols={2}>
  ...
  <Card title="Middleware" icon="layer-group" href="/en/versions/2.0.6/building-blocks/middleware">
    How to hook into reply, reasoning, acting, and model calls.
  </Card>
  <Card title="Workspace" icon="box" href="/en/versions/2.0.6/building-blocks/workspace/overview">
    How to work in different sandboxes.
  </Card>
  <Card title="Permission System" icon="lock" href="/en/versions/2.0.6/building-blocks/permission-system/overview">
