...
- **Task tools** added: `TaskCreate`, `TaskGet`, `TaskList`, and `TaskUpdate` (see the [Plan](/en/versions/2.0.6/building-blocks/plan) page). ([#1549](https://github.com/agentscope-ai/agentscope/pull/1549))
