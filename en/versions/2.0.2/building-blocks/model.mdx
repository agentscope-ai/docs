...
Additional arguments for `DashScopeRealtimeTTSModel`:
...
In the agent layer, TTS is integrated via [`TTSMiddleware`](/en/versions/2.0.2/building-blocks/middleware#ttsmiddleware) — it intercepts the agent's text output and synthesizes speech automatically:
