...
|------------|-------------|
| Agent teams | A leader agent spawns worker agents and coordinates them through built-in team tools; see the [Agent Team](/en/versions/2.0.2/deploy/agent-team) chapter. |
...
<CardGroup cols={2}>
  ...
  <Card title="Message & Event" icon="envelope" href="/en/versions/2.0.2/building-blocks/message-and-event">
