...
<Steps>
  ...
  <Step title="Configure routing rules">
    Choose which agent handles messages and how sessions are scoped. See [Message Routing](/en/versions/2.0.8/deploy/channel/routing) for what the rules mean.
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Discord" icon="discord" href="/en/versions/2.0.8/deploy/channel/discord" cta="Learn more" arrow>
