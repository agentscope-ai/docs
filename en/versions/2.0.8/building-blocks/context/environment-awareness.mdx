...
The `context_buffer_ratio` behind the context usage dimension lives in the [context config](/en/versions/2.0.8/building-blocks/context/compress-context#configure-compression); the other three dimensions are governed by `InjectionConfig`.
