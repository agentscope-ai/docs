...
In the agent layer, TTS is integrated via [`TTSMiddleware`](/en/versions/2.0.8/building-blocks/middleware#ttsmiddleware), which intercepts the agent's text output and synthesizes speech automatically:
