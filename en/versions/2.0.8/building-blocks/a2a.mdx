...
<CardGroup cols={2}>
  <Card title="Console" icon="terminal" href="/en/versions/2.0.8/building-blocks/console" cta="Learn more" arrow>
    Hand a remote agent to the terminal and start chatting.
  </Card>
  <Card title="Message and Event" icon="message-square" href="/en/versions/2.0.8/building-blocks/message-and-event" cta="Learn more" arrow>
