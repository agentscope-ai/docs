...
description: 'An intelligent multi-agent system for automated data processing using natural language'
icon: 'route'
---
...
<Frame>
  <img src="assets/dj_agent_image.png" alt="Data Processing Agent example log in AgentScope Studio" />
</Frame>
</Accordion>
...
<Accordion title="View Complete Example Log (from AgentScope Studio)">
<Frame>
  <img src="assets/dj_dev_agent_image.png" alt="DJ Dev Agent example log in AgentScope Studio" />
</Frame>
</Accordion>
...
<Frame>
  <img src="https://github.com/user-attachments/assets/d10a95a8-fb7a-494f-b858-f21e5996790b" alt="Data-Juicer Q&A Agent example" />
</Frame>
