---
title: 'Evaluation'
description: 'The CI/CD Pipeline for Intelligent Agents: From "Code Checks" to "Cognitive Checks"'
icon: 'chart-line'
---
...
<Frame>
  <img src="../images/evaluation.png" alt="AgentScope Evaluation Framework overview" />
</Frame>
