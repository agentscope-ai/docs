...
For programmatic access to usage after a model call, use the `usage` field on the [ChatResponse](/en/versions/1.0.21/building-blocks/models) returned by the model.
...
For evaluation of agent behavior and benchmarks, see [Evaluation](/en/versions/1.0.21/observe-and-evaluate/evaluation).
