...
description: 'The mechanisms for secure code execution and external tool integration'
icon: 'box'
---
...
**ARM64/Apple M-series:** You may encounter compatibility issues. Running on an x86_64 host is recommended.
</Warning>
