...
<Info>
For core concepts and design principles, see [Model](/en/versions/1.0.21/basic-concepts/model). For details on `Msg` and content blocks, see [Msg](/en/versions/1.0.21/basic-concepts/msg).
</Info>
...
<Tip>
Use the `Toolkit` class to auto-generate JSON schemas from Python functions with docstrings. See [Tool](/en/versions/1.0.21/basic-concepts/tool) for details.
</Tip>
