...
<CardGroup cols={2}>
  <Card title="Context and Memory" icon="memory" href="/en/versions/1.0.21/building-blocks/context-and-memory">
    Memory backends for storing and managing session messages.
  </Card>
  <Card title="Agent" icon="user-robot" href="/en/versions/1.0.21/building-blocks/agent">
