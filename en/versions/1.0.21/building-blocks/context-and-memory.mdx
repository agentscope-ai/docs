...
> For conceptual background, see [Context and Memory](/en/versions/1.0.21/basic-concepts/context-and-memory).
...
<CardGroup cols={2}>
  <Card title="Agent" icon="user-robot" href="/en/versions/1.0.21/basic-concepts/agent">
    Understand the agent's core methods and the ReAct paradigm.
  </Card>
  <Card title="Tool" icon="wrench" href="/en/versions/1.0.21/basic-concepts/tool">
