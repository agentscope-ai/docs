...
Continuing from [Overview](/en/versions/1.0.21/tune-agent/tune-your-first-agent#workflow-function), assume you have a task dataset and judge function ready. Now, refine your workflow function for prompt tuning:
