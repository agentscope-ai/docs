...
- [**Hooking Functions**](/en/versions/1.0.21/building-blocks/hooking-functions) — Detailed usage of agent hooks, including Human-in-the-Loop patterns
- [**Orchestration**](/en/versions/1.0.21/building-blocks/orchestration) — In-depth guide to routing strategies, MsgHub, and Orchestrator-Workers patterns
