...
- [**Context and Memory**](/en/versions/1.0.21/building-blocks/context-and-memory) — Complete guide to short-term and long-term memory
- [**Tool Capabilities**](/en/versions/1.0.21/building-blocks/tool-capabilities) — Complete guide to tools and function calling
- [**Agent**](/en/versions/1.0.21/basic-concepts/agent) — Agent customization and advanced features
