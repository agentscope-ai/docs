...
Pass any object satisfying this protocol to the agent's `offloader` argument. Every built-in [workspace](/en/versions/2.0.9dev/building-blocks/workspace/overview) (local, Docker, E2B, ...) implements the protocol and can serve as the offloader directly:
