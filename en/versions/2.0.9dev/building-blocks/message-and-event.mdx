...
| `structured_output` | `dict \| None`                | The validated structured result when the reply required a [structured schema](/en/versions/2.0.9dev/building-blocks/agent/run-agent#structured-output); set by the agent on the final message |
