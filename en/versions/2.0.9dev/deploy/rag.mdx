...
<CardGroup cols={2}>
  <Card title="RAG" icon="cubes" href="/en/versions/2.0.9dev/building-blocks/rag" cta="View library-mode usage" arrow>
    Learn the atomic interfaces of parser / chunker / vector store / middleware and their library-mode usage.
  </Card>
  <Card title="Architecture" icon="sitemap" href="/en/versions/2.0.9dev/deploy/agent-service" cta="View create_app parameters" arrow>
