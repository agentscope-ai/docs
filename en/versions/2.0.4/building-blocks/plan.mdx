...
- [Tool](/en/versions/2.0.4/building-blocks/tool) — the toolkit, the `ToolBase` interface, and how state-injected tools receive `AgentState`.
- [Agent](/en/versions/2.0.4/building-blocks/agent) — the agent lifecycle, including how `AgentState` is created, restored, and persisted.
