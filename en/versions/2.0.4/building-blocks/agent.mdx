...
<CardGroup cols={2}>
  <Card title="Permission System" href="/en/versions/2.0.4/building-blocks/permission-system">
    Control which tools the agent can call and under what conditions.
  </Card>
  <Card title="Middleware" href="/en/versions/2.0.4/building-blocks/middleware">
