...
- [LLM](/en/versions/2.0.7/building-blocks/model/llm): drives an agent's conversation and tool calls
- [TTS](/en/versions/2.0.7/building-blocks/model/tts): converts text into synthesized speech audio
- [Embedding](/en/versions/2.0.7/building-blocks/model/embedding): converts text and media into dense vectors
...
<CardGroup cols={2}>
  <Card title="LLM" icon="message" href="/en/versions/2.0.7/building-blocks/model/llm" cta="Learn more" arrow>
    Create and call chat models, generate structured output, and add custom providers.
  </Card>
  <Card title="TTS" icon="volume-high" href="/en/versions/2.0.7/building-blocks/model/tts" cta="Learn more" arrow>
    Synthesize speech in standard and realtime modes, and integrate TTS with agents.
  </Card>
  <Card title="Embedding" icon="cube" href="/en/versions/2.0.7/building-blocks/model/embedding" cta="Learn more" arrow>
