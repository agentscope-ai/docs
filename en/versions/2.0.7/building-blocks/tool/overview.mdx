...
<CardGroup cols={2}>
  <Card title="Python Tool" icon="code" href="/en/versions/2.0.7/building-blocks/tool/python-tool">
    Built-in tools, custom tools, function wrapping, and tool middleware.
  </Card>
  <Card title="MCP" icon="plug" href="/en/versions/2.0.7/building-blocks/tool/mcp">
    Connect MCP servers and use their tools.
  </Card>
  <Card title="Skill" icon="book-open" href="/en/versions/2.0.7/building-blocks/tool/skill">
    Extend agent capabilities with markdown instruction sets.
  </Card>
  <Card title="Meta Tool" icon="toggle-on" href="/en/versions/2.0.7/building-blocks/tool/manage-tools">
...
<CardGroup cols={2}>
  ...
  <Card title="Permission System" icon="shield" href="/en/versions/2.0.7/building-blocks/permission-system/overview">
