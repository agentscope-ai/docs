...
<Note>
Use `agent.state.reply_id` to reference the reply that is currently paused. See [Human-in-the-Loop](/en/versions/2.0.7/building-blocks/agent/human-in-the-loop) for how the agent enters a paused state.
</Note>
