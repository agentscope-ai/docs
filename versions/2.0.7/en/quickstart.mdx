---
title: "Quickstart"
description: "Get up and running with AgentScope 2.0 in minutes"
---
...
```bash
uv pip install "agentscope==2.0.7"
```

### From Source

```bash
git clone -b v2.0.7 https://github.com/agentscope-ai/agentscope
cd agentscope
uv pip install -e .
```
...
```bash
uv pip install "agentscope[full]==2.0.7"
```
