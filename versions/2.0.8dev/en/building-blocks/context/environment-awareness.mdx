...
The `context_buffer_ratio` behind the context usage dimension lives in the [context config](/versions/2.0.8dev/en/building-blocks/context/compress-context#configure-compression); the other three dimensions are governed by `InjectionConfig`.
