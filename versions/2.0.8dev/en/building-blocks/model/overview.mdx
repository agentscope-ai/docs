...
<Tip>
**Realtime Model** powers full-duplex voice conversations. See [Full-Duplex Voice Agent](/versions/2.0.8dev/en/building-blocks/realtime/full-duplex) for how to create and use one; more provider APIs are coming soon.
</Tip>
