...
<Note>
The management UI maps onto the `/channels` endpoints; call them directly when you need to create channels programmatically. See the [API](/versions/2.0.9dev/en/deploy/openapi.json) part of this chapter for the fields.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Feishu" icon="comment" href="/versions/2.0.9dev/en/deploy/channel/feishu" cta="Learn more" arrow>
