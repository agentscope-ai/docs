...
- Receiving and replying to user messages on IM platforms such as Feishu, DingTalk, Discord, and Telegram;
...
| Telegram | `telegram` | Bot API long polling | Available |
...
<CardGroup cols={2}>
  ...
  <Card title="Connect Telegram" icon="telegram" href="/versions/2.0.9dev/en/deploy/channel/telegram" cta="Learn more" arrow>
    Create a Telegram bot and let agents chat in Telegram.
  </Card>
