...
<Tip>
For embedding models and how to configure them, see the [Embedding Model chapter](/versions/2.0.9dev/en/building-blocks/model/embedding); for the service version of RAG (with an HTTP service, file hosting, and distributed indexing), see [RAG Service](/versions/2.0.9dev/en/deploy/rag).
</Tip>
...
See the [Embedding Model chapter](/versions/2.0.9dev/en/building-blocks/model/embedding).
...
<CardGroup cols={1}>
  <Card title="RAG Service" icon="server" href="/versions/2.0.9dev/en/deploy/rag" cta="View deployment docs" arrow>
