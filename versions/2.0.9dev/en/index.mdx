...
<CardGroup cols={1}>
	<Card title="ReAct Agent" icon="robot" href="/versions/2.0.9dev/en/building-blocks/agent/overview" cta="Get Started">
	...
	<Card title="Toolkit" icon="toolbox" href="/versions/2.0.9dev/en/building-blocks/tool/overview" cta="Learn about toolkit">
		Agent self-managed tool system with Python functions, MCP and skills integration.
	</Card>
	<Card title="Context" icon="memory" href="/versions/2.0.9dev/en/building-blocks/context/overview" cta="View context">
	...
	<Card title="Sandbox Isolation" icon="codepen" href="/versions/2.0.9dev/en/building-blocks/workspace/overview" cta="Learn about sandbox">
	...
	<Card title="Agent as Service" icon="server" href="/versions/2.0.9dev/en/deploy/agent-service" cta="Learn about agent service">
