...
<Steps>
  ...
  <Step title="Equip an agent's workspace">
    In a chat, the user picks from the pool to unpack the skill into that agent's [workspace](/versions/2.0.8/en/deploy/workspace-manager). The agent can follow it from that point on.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  <Card title="MCP Hub" icon="plug" href="/versions/2.0.8/en/deploy/hub/mcp-hub" cta="Read more" arrow>
    The same idea for MCP servers.
  </Card>
  <Card title="Skill" icon="book-open" href="/versions/2.0.8/en/building-blocks/tool/skill" cta="Read more" arrow>
